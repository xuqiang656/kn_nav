...
bool TraversabilityMap::traversabilityFootprint(double footprintYaw) {
  ...
  // Compute footprint orientations.
  Eigen::Quaterniond orientationX = Eigen::Quaterniond::Identity();
  Eigen::Quaterniond orientationRot(Eigen::AngleAxisd(footprintYaw, Eigen::Vector3d::UnitZ()));
