...
ob::ScopedState<> Converter::poseRosToOmpl(const geometry_msgs::msg::PoseStamped& pose_ros) const {
...
nav_msgs::msg::Path Converter::pathOmplToRos(const og::PathGeometric& path_ompl) const {
