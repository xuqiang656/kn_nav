...
1. `colcon build --packages-select art_planner_motion_cost`
...
3. Change height map topic in `launch/cost_query_server.launch.py`
4. Run `ros2 launch art_planner_motion_cost cost_query_server.launch.py`.
